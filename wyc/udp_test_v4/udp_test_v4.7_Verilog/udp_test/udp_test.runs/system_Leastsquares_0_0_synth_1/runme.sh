...
HD_PWD='D:/vivado/PRO/udp_test_v4.7_Verilog/udp_test/udp_test.runs/system_Leastsquares_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_Leastsquares_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_Leastsquares_0_0.tcl
